...
class ContactsTVC: UITableViewController {
  ...
  @IBAction func addNewContact(_ sender: UIBarButtonItem) {
    ...
    newContactTVC.updateButtonOutlet.title = ""
    newContactTVC.navigationItem.title = "Создать контакт"
  ...
  @IBAction func updateUnwindSegue(unwindSegue: UIStoryboardSegue) {
    ...
    // обновлять данные контакта из поиска
    if isFiltering {
  ...
  override func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
    ...
    header.textLabel?.text = "Контакты"
  }
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    showTableVC.navigationItem.title = "Информация"
